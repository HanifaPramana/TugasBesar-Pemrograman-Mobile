...
public class maps_cairo extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_cairo);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng cairo = new LatLng(-7.9867585, 112.6264252);
        mMap.addMarker(new MarkerOptions().position(cairo).title("RM Cairo"));
