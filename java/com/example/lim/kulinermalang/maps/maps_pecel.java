...
public class maps_pecel extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_pecel);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng pecel = new LatLng(-7.975696, 112.6177973);
        mMap.addMarker(new MarkerOptions().position(pecel).title("Pecel Kawi"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(pecel));
    }
}
