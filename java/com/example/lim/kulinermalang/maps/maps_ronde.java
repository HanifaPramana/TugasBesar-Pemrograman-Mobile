...
public class maps_ronde extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_ronde);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng ronde = new LatLng(-7.9823284, 112.6325173);
        mMap.addMarker(new MarkerOptions().position(ronde).title("Ronde Titoni"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(ronde));
    }
}
