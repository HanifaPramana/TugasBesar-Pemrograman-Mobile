...
public class maps_stmj extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_stmj);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng stmj = new LatLng(-7.9745567, 112.6344596);
        mMap.addMarker(new MarkerOptions().position(stmj).title("STMJ29"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(stmj));
    }
}
